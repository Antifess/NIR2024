...
Q_CONSTINIT static const uint qt_meta_data_CLASSSerialPortENDCLASS[] = {
 ...
 // signals: parameters
    QMetaType::Void, QMetaType::QByteArray, QMetaType::Int,    2,    3,
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->dataReceived((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        {
            using _t = void (SerialPort::*)(QByteArray , int );
...
// SIGNAL 0
void SerialPort::dataReceived(QByteArray _t1, int _t2)
{
